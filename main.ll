...
@_swift1_autolink_entries = private constant [152 x i8] c"-lFoundation\00-lswift_Concurrency\00-lswiftCore\00-lswiftGlibc\00-lm\00-lpthread\00-lutil\00-ldl\00-lswiftDispatch\00-ldispatch\00-lBlocksRuntime\00-lswiftSwiftOnoneSupport\00", section ".swift1_autolink_entries", align 8
@llvm.used = appending global [4 x i8*] [i8* bitcast (void ()* @kmain to i8*), i8* bitcast (void ()** @"_swift_FORCE_LOAD_$_swiftGlibc_$_main" to i8*), i8* bitcast (i16* @__swift_reflection_version to i8*), i8* getelementptr inbounds ([152 x i8], [152 x i8]* @_swift1_autolink_entries, i32 0, i32 0)], section "llvm.metadata", align 8
...
attributes #0 = { "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
!3 = !{i32 4, !"Objective-C Garbage Collection", i32 84215552}
!4 = !{i32 1, !"Swift Version", i32 7}
!5 = !{[152 x i8]* @_swift1_autolink_entries, null, null, i1 false, i1 true}
